...
from mbse.utils.vec_env.base_vec_env import VecEnv, VecEnvObs, VecEnvStepReturn, VecEnvWrapper
...
class VecMonitor(VecEnvWrapper):
    ...
    def __init__(
        ...
        from mbse.utils.vec_env.monitor import Monitor, ResultsWriter
    ...
    def step_wait(self) -> VecEnvStepReturn:
        obs, rewards, terminate, truncate, infos = self.venv.step_wait()
        ...
        for i in range(len(dones)):
            if dones[i]:
                ...
                new_infos[i] = info
        return obs, rewards, terminate, truncate, new_infos
