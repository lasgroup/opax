...
def experiment(logs_dir: str, use_wandb: bool, exp_name: str, time_limit: int, n_envs: int,
    ...
    test_env_swing_up = make_vec_env(env_id=CustomPendulumEnv, wrapper_class=wrapper_cls, n_envs=1, seed=seed,
                                     env_kwargs=env_kwargs_swing_up)
    test_env = [test_env_swing_up]
    reward_model = PendulumReward(action_space=env.action_space, target_angle=0.0)
    ...
    if exploration_strategy == 'PETS':
        dynamics_model = GPDynamicsModel(
            ...
            is_active_exploration_model=True,
            pred_diff=True,
        ...
        dynamics_model = GPDynamicsModel(
            ...
            observation_space=env.observation_space,
            reward_model=reward_model,
            is_active_exploration_model=False,
            pred_diff=True,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--total_train_steps', type=int, default=50000)
