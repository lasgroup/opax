...
def experiment(
    ...
    reward_model = CartPoleRewardModel(num_poles=1, action_cost=action_cost)
    env_kwargs = {
        'reward_model': reward_model,
        'render_mode': 'rgb_array'
    }

    from opax.envs.cartpole import CartPoleDM
    from opax.envs.cartpole import CartPoleDM
    env = make_vec_env(env_id=CartPoleDM, wrapper_class=wrapper_cls, n_envs=n_envs, seed=seed,
                       env_kwargs=env_kwargs)
    test_env = make_vec_env(CartPoleDM, wrapper_class=wrapper_cls_test, seed=seed,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exploration_strategy', type=str, default='OMBRL')
