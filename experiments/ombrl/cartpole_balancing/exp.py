...
def experiment(
    ...
    from opax.envs.cartpole import CartPoleBalance
    env = make_vec_env(env_id=CartPoleBalance, wrapper_class=wrapper_cls, n_envs=n_envs, seed=seed,
                       env_kwargs=env_kwargs)
    test_env = make_vec_env(CartPoleBalance, wrapper_class=wrapper_cls_test, seed=seed,
