...
import wandb
from opax.models.ombrl_model import OMBRLModel
from opax.models.hucrl_model import HUCRLModel
from opax.models.environment_models.soft_arm_reward import SoftArmRewardModel
...
def experiment(
    ...
    reward_model = SoftArmRewardModel(target_position=target_position,
                                      # target_orientation=target_orientation,
                                      obs_state_points=obs_state_points,
    ...
    from opax.envs.soft_arm import SoftArmReachOrienEnv
    env = make_vec_env(env_id=SoftArmReachOrienEnv, wrapper_class=wrapper_cls, n_envs=n_envs, seed=seed,
                       env_kwargs=env_kwargs)
    test_env = make_vec_env(SoftArmReachOrienEnv, wrapper_class=wrapper_cls_test, seed=seed,
    ...
    elif exploration_strategy == 'OMBRL':
        dynamics_model = OMBRLModel(
            action_space=env.action_space,
            observation_space=env.observation_space,
            num_ensemble=num_ensembles,
            reward_model=reward_model,
