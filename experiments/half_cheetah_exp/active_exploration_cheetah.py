...
def experiment(logs_dir: str, use_wandb: bool, time_limit: int, n_envs: int, exp_name: str,
    ...
    reward_model_forward = HalfCheetahReward(forward_velocity_weight=1.0, ctrl_cost_weight=0.0,
                                             penalise_flipping=False)
    reward_model_backward = HalfCheetahReward(forward_velocity_weight=-1.0, ctrl_cost_weight=0.0,
                                              penalise_flipping=False)
    env_kwargs_train = {
