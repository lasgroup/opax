...
from opax.utils.vec_env.base_vec_env import VecEnv, VecEnvObs, VecEnvStepReturn, VecEnvWrapper
...
class VecMonitor(VecEnvWrapper):
    ...
    def __init__(
        ...
        from opax.utils.vec_env.monitor import Monitor, ResultsWriter
